...
@Component({
  ...
  <mat-card>
    ...
    <form (ngSubmit)=\"submit()\">
      <mat-form-field class=\"full\"><input matInput placeholder=\"Full name\" [(ngModel)]=\"fullName\" name=\"fullName\"></mat-input></mat-form-field>
      ...
      <mat-form-field class=\"full\"><input matInput placeholder=\"Area (optional)\" [(ngModel)]=\"area\" name=\"area\"></mat-input></mat-form-field>
